...
import Hercules.Database.Extra       (Project, ProjectWithJobsetsWithStatus, Job, JobsetevalWithStatus)
...
type Unprotected =
 ...
 :<|> "projects" :> Capture "projectName" Text :> Capture "jobsetName" Text :> "jobs" :> Get '[JSON] [Job]
